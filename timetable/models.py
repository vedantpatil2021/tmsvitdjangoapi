...
class Timetable_history(models.Model):
    # Define your fields here
    tt_id = models.AutoField(primary_key=True,)
    tt_dept = models.CharField(max_length=100)
    tt_name = models.CharField(max_length=100)
    tt_unique_id = models.CharField(max_length=100)
    tt_status = models.CharField(max_length=100)
    tt_date = models.CharField(max_length=100)
    tt_time = models.CharField(max_length=100)
    tt_is_public = models.CharField(max_length=100)
    tt_public_key = models.CharField(max_length=100)

    class Meta:
        db_table = 'timetable_history'  # Replace 'your_table_name' with your actual table name
        app_label = 'timetable'  # Replace 'your_app' with the name of your Django app